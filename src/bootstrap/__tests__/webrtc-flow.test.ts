...
import { Bootstrap, BootstrapType } from '../bootstrap'
...
const WebRtcTestHelper = {
  bootstrap: async (client: BootstrapType) => {
  ...
  cleanup: async (client: BootstrapType) => {
...
let wallet: BootstrapType
let extension: BootstrapType
